...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.set_online_at'
        db.add_column('mod_server', 'set_online_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 2, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Server.server_info'
        db.add_column('mod_server', 'server_info',
                      self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.set_online_at'
        db.delete_column('mod_server', 'set_online_at')

        # Deleting field 'Server.server_info'
        db.delete_column('mod_server', 'server_info')
