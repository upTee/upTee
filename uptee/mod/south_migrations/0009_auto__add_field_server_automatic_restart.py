...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.automatic_restart'
        db.add_column('mod_server', 'automatic_restart',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.automatic_restart'
        db.delete_column('mod_server', 'automatic_restart')
