...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Server', fields ['owner']
        db.delete_unique('mod_server', ['owner_id'])


        # Changing field 'Server.port'
        db.alter_column('mod_server', 'port_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['mod.Port']))
        # Adding unique constraint on 'Server', fields ['port']
        db.create_unique('mod_server', ['port_id'])


        # Changing field 'Server.owner'
        db.alter_column('mod_server', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):
        # Removing unique constraint on 'Server', fields ['port']
        db.delete_unique('mod_server', ['port_id'])


        # Changing field 'Server.port'
        db.alter_column('mod_server', 'port_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mod.Port']))

        # Changing field 'Server.owner'
        db.alter_column('mod_server', 'owner_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'Server', fields ['owner']
        db.create_unique('mod_server', ['owner_id'])
